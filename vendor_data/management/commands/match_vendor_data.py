...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        titles = sorted(
            {m.title_he for m in
             Movie.objects.active().filter(title_he__isnull=False)})
        ...
        try:
            for o in qs:  # type: models.VendorItem
                ...
                if not mqs.count():
                    ...
                    print(o.title_he or o.title_en)
                    w = near[0]
                ...
                if director:
                    r = m.people.filter(Q(person__name_he=director) | Q(
                        person__name_en=director), role__idea_tid="BAMAI")
                    if r:
                        o.entity = m
                        o.status = o.Status.ASSIGNED
                        o.save()
                ...
                print(o.title_he or o.title_en)
                print("* Year", o.year, m.year)
                print("* Duration", o.duration, m.duration)
                if director:
